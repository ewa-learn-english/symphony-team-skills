...
Return plan findings to `plan-author` and requirement gaps to `spec-author`. Continue this thread for re-review and do not repeat an unchanged review. Work in the shared current checkout and preserve unrelated changes.
